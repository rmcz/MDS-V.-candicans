...
##########ACCESS8.5 LIMA
#Cargar datos
map <- raster("D:/Maxent/AREA Y LIMA2/Vasconcellea_candicans_ACCES85.asc")
plot(map)
...
levelplot(cat.act, at = breaks, col.regions = cols, main = "Distribución futura ACCES85",
...
aact #aha
########BARPLOT
bp<- barplot(aact, ylim=c(0,1373632),
             #main = "Area (km^2)",
             xlab = "Idoneidad",
             ylab = "Área (km^2)",
...
bp1<- barplot(a45, ylim=c(0,29936),
              #main = "Area (km^2)",
              xlab = "Idoneidad",
              ylab = "Área (km^2)",
              col = c( "gray93", "green4", "yellow", "red"), border = T, 
